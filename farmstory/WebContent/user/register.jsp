...
<script src="/farmstory/js/checkHp.js"></script>
<script src="/farmstory/js/checkNick.js"></script>
<script src="/farmstory/js/checkEmail.js"></script>

<div id="member">
	<section class="register">
		<form id="regForm" action="/farmstory/user/registerProc.jsp" method="POST">
			<section>
				<table>
			...
			<div>
				<a href="/farmstory/user/login.jsp" class="cancel">취소</a> 
